...
@CucumberOptions(features="src\\test\\resources\\Feature",glue="org.newadactin",dryRun =false,
monochrome=true,strict=false,
plugin={"pretty","html:target\\Reports","json:target\\Reports\\Output.json","junit:target\\Reports\\fb.xml",
